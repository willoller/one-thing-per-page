...
class mysql::config(
  ...
  $binary_logs          = $mysql::params::binary_logs,
  $log_bin              = $mysql::params::log_bin,
  $binlog_do_db         = $mysql::params::binlog_do_db,
  $server_id            = $mysql::params::server_id,
  $slave_replication    = $mysql::params::slave_replication,
  $master_host          = $mysql::params::master_host,
